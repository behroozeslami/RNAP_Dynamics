 function mlfunc=ML_func_CG(params, B, Weights, bincenter, gamma_nums, Nw, t_strt, t_end, Dobcktrck)

pause_num = length(gamma_nums);

[q_array, k_array, sigma_ln, t_bar] = MLparams2modelparams(params, pause_num);
