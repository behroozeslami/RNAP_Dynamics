function Analyze_10AF_kel_P_SingleTraces_bts(delta, data_name, subfolder_name, selected_trace_indices) 

mainfoldername = 'EXPORT_AF_10pN_1mM_NTP';

grid_name = ['ML_grid_10AF_delta=' num2str(delta)];

simul_name = ['Simul_DWTpdf_10AF_delta=' num2str(delta)];

save_folder = ['Analysis_10AF_delta=' num2str(delta) '_SingleTraces_kel-P'];
