function Analyze_10uM_kel_P_SingleTraces_bts(data_name, subfolder_name, selected_trace_indices) 

mainfoldername = 'NEW_AF_7.5pN_10uM_NTP';

grid_name = 'ML_grid_10uM';

simul_name = 'Simul_DWTpdf_10uM';

save_folder = 'Analysis_10uM_SingleTraces_kel-P';
