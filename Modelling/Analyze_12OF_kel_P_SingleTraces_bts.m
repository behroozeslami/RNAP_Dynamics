function Analyze_12OF_kel_P_SingleTraces_bts(delta, data_name, subfolder_name, selected_trace_indices) 

mainfoldername = 'EXPORT_OF_12.5pN_1mM_NTP';

grid_name = ['ML_grid_12OF_delta=' num2str(delta)];

simul_name = ['Simul_DWTpdf_12OF_delta=' num2str(delta)];

save_folder = ['Analysis_12OF_delta=' num2str(delta) '_SingleTraces_kel-P'];
