function Analyze_500uM_kel_P_SingleTraces_bts(data_name, subfolder_name, selected_trace_indices) 

mainfoldername = 'EXPORT_AF_7.5pN_0.5mM_NTP';

grid_name = 'ML_grid_500uM';

simul_name = 'Simul_DWTpdf_500uM';

save_folder = 'Analysis_500uM_SingleTraces_kel-P';
