function Analyze_5AF_kel_P_SingleTraces_bts(delta, data_name, subfolder_name, selected_trace_indices) 

mainfoldername = 'EXPORT_AF_5pN_1mM_NTP';

grid_name = ['ML_grid_5AF_delta=' num2str(delta)];

simul_name = ['Simul_DWTpdf_5AF_delta=' num2str(delta)];

save_folder = ['Analysis_5AF_delta=' num2str(delta) '_SingleTraces_kel-P'];
