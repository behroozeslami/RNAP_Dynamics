function Analyze_7OF_kel_P_SingleTraces_bts(delta, data_name, subfolder_name, selected_trace_indices) 

mainfoldername = 'EXPORT_OF_7.5pN_1mM_NTP_NoB2';

grid_name = ['ML_grid_7OF_delta=' num2str(delta)];

simul_name = ['Simul_DWTpdf_7OF_delta=' num2str(delta)];

save_folder = ['Analysis_7OF_delta=' num2str(delta) '_SingleTraces_kel-P'];
