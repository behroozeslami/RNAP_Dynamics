function Analyze_9OF_kel_P_SingleTraces_bts(delta, data_name, subfolder_name, selected_trace_indices) 

mainfoldername = 'OF4_9pN_1mM_NTP_Control';

grid_name = ['ML_grid_9OF_delta=' num2str(delta)];

simul_name = ['Simul_DWTpdf_9OF_delta=' num2str(delta)];

save_folder = ['Analysis_9OF_delta=' num2str(delta) '_SingleTraces_kel-P'];
