...
str_Param = 'Parameters/Backtrack_Model_Parameters_raw_Select_AF_7.5pN_1mM_NTP.xlsx';
...
[Simul_DWT_hist, DWT_array, Proc_data] = Simulate_dwellTime_pdf(Model_ID, Params, t0, Trace_time, DWT_num, W, Nw, noise, noise_type, bins_exp);
