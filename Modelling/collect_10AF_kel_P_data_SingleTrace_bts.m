...
grid_name = '10AF_kel_P_grid.txt';

New_grid2D_name = '10AF_kel_P_grid_2.txt';

data_name = ['10AF' '_' 'delta=' num2str(delta)];

save_grid_name = ['ML_grid_10AF' '_' 'delta=' num2str(delta)];

simul_name = ['Simul_DWTpdf_10AF' '_' 'delta=' num2str(delta)];
