...
grid_name = '10OF_kel_P_grid.txt';

New_grid2D_name = '10OF_kel_P_grid_2.txt';

data_name = ['10OF' '_' 'delta=' num2str(delta)];

save_grid_name = ['ML_grid_10OF' '_' 'delta=' num2str(delta)];

simul_name = ['Simul_DWTpdf_10OF' '_' 'delta=' num2str(delta)];
