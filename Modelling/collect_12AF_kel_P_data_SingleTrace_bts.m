...
grid_name = '12AF_kel_P_grid.txt';

New_grid2D_name = '12AF_kel_P_grid_2.txt';

data_name = ['12AF' '_' 'delta=' num2str(delta)];

save_grid_name = ['ML_grid_12AF' '_' 'delta=' num2str(delta)];

simul_name = ['Simul_DWTpdf_12AF' '_' 'delta=' num2str(delta)];
