...
grid_name = '5AF_kel_P_grid.txt';

New_grid2D_name = '5AF_kel_P_grid_2.txt';

data_name = ['5AF' '_' 'delta=' num2str(delta)];

save_grid_name = ['ML_grid_5AF' '_' 'delta=' num2str(delta)];

simul_name = ['Simul_DWTpdf_5AF' '_' 'delta=' num2str(delta)];
