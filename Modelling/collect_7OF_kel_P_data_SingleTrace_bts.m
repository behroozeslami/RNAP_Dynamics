...
grid_name = '7OF_kel_P_grid.txt';

New_grid2D_name = '7OF_kel_P_grid_2.txt';

data_name = ['7OF' '_' 'delta=' num2str(delta)];

save_grid_name = ['ML_grid_7OF' '_' 'delta=' num2str(delta)];

simul_name = ['Simul_DWTpdf_7OF' '_' 'delta=' num2str(delta)];
