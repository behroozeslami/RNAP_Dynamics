...
grid_name = 'GreA_OF_ke2_kp3_grid.txt';

New_grid2D_name = 'GreA_OF_ke2_kp3_grid_2.txt';

data_name = 'GreA_OF';

save_grid_name = 'ML_grid_GreA_OF';
...
%output_foldername = 'OF4_9pN_1mM_NTP_GreA_M';
output_foldername = 'OF4_9pN_1mM_NTP_GreA_c';
...
Fit_folder = [output_foldername, '/Fit_Results' '_'];
