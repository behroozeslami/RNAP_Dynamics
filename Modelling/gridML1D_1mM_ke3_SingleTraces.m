function [] = gridML1D_1mM_ke3_SingleTraces(ke3)
...
str_Fit_dat = [Fit_folder slash 'Fit_Results' '_' Param_name{1} '=' num2str(ke3)  '_' 'Ts='  num2str((2*W+1)*t0) 's' '_' 'Nw=' num2str(Nw) '_' 'limits=' num2str(t_strt) '-' num2str(t_end)];
