function [] = gridML1D_9OF_GreB_ke3_bts(ke3)
...
Fit_folder = [output_foldername slash 'Fit_Results' '_' Param_name_1{1} '_' 'Ts=' num2str((2*W+1)*t0) 's' '_' 'Nw=' num2str(Nw)];
...
str_Fit_dat = [Fit_folder slash 'Fit_Results' '_'  Param_name_1{1} '=' num2str(ke3) '_' 'Ts='  num2str((2*W+1)*t0) 's' '_' 'Nw=' num2str(Nw) '_' 'limits=' num2str(t_strt) '-' num2str(t_end)];

str_simul_dat = [Fit_folder slash 'Simul_DWTpdf' '_' Param_name_1{1} '=' num2str(ke3) '_' 'Ts='  num2str((2*W+1)*t0) 's' '_' 'Nw=' num2str(Nw)];

Params(fit_index_1) = ke3; 

Params(1) = 21; % Control

Params(2) = 0.1; % Control

Params(4) = 0.4604; % 2-param fit GreB

Params(7) = 0.019668; % 2-param fit GreB
