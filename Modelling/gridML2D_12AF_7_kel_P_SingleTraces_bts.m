function [] = gridML2D_12AF_7_kel_P_SingleTraces_bts(kel, P)
...
mainfoldername = 'Export_AF_12.5pN_1mM_NTP';
...
Fit_folder = [output_foldername slash 'Fit_Results' '_' 'delta=' num2str(delta) '_' Param_name_1{1} '-' Param_name_2{1} '_' 'Ts=' num2str((2*W+1)*t0) 's' '_' 'Nw=' num2str(Nw)];
...
str_Fit_dat = [Fit_folder slash 'Fit_Results' '_' 'delta=' num2str(delta) '_'  Param_name_1{1} '=' num2str(kel) '_', Param_name_2{1} '=' num2str(P) '_' 'Ts='  num2str((2*W+1)*t0) 's' '_' 'Nw=' num2str(Nw) '_' 'limits=' num2str(t_strt) '-' num2str(t_end)];

str_simul_dat = [Fit_folder slash 'Simul_DWTpdf' '_' 'delta=' num2str(delta) '_' Param_name_1{1} '=' num2str(kel) '_', Param_name_2{1} '=' num2str(P) '_' 'Ts='  num2str((2*W+1)*t0) 's' '_' 'Nw=' num2str(Nw)];
