function [] = gridML2D_1mM_kel_P1_SingleTraces_bts(kel, P1)
...
str_Fit_dat = [Fit_folder slash 'Fit_Results' '_' Param_name_1{1} '=' num2str(kel) '_', Param_name_2{1} '=' num2str(P1) '_' 'Ts='  num2str((2*W+1)*t0) 's' '_' 'Nw=' num2str(Nw) '_' 'limits=' num2str(t_strt) '-' num2str(t_end)];

str_simul_dat = [Fit_folder slash 'Simul_DWTpdf' '_' Param_name_1{1} '=' num2str(kel) '_', Param_name_2{1} '=' num2str(P1) '_' 'Ts='  num2str((2*W+1)*t0) 's' '_' 'Nw=' num2str(Nw)];

Params(fit_index_1) = kel; 

Params(fit_index_2) = P1;
...
Simul_data = [kel, P1, Simul_DWT_hist];
