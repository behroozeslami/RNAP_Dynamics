function [] = gridML2D_ITP_kp2_bts(kp2)
...
str_Fit_dat = [Fit_folder slash 'Fit_Results' '_'  Param_name_1{1} '=' num2str(kp2) '_' 'Ts='  num2str((2*W+1)*t0) 's' '_' 'Nw=' num2str(Nw) '_' 'limits=' num2str(t_strt) '-' num2str(t_end)];

str_simul_dat = [Fit_folder slash 'Simul_DWTpdf' '_' Param_name_1{1} '=' num2str(kp2) '_' 'Ts='  num2str((2*W+1)*t0) 's' '_' 'Nw=' num2str(Nw)];

Params(fit_index_1) = kp2; 

Params(1) = 21; % Control

Params(2) = 0.194; % Control
