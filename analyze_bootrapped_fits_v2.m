...
output_file_str = [param_foldername slash 'General_Model_NewSel_Parameters' '_' 'raw' '_' output_foldername '.xlsx'];
...
dat_micro = Micromodel_1_params(dat(2,1:pause_num+1), dat(2,pause_num+2:2*pause_num+1));

output_file_str_2 = [param_foldername slash 'Micro_Model_1_NewSel_Parameters' '_' 'raw' '_' output_foldername '.xlsx'];
