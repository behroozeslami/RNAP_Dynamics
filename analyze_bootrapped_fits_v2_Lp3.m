...
output_file_str = [param_foldername slash 'General_Model_Parameters' '_' 'raw' '_' output_foldername '.xlsx'];
...
output_file_str_2 = [param_foldername slash 'Micro_Model_1_Parameters' '_' 'raw' '_' output_foldername '.xlsx'];
